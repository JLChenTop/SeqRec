...
class GRU4Rec_test(SequentialRecommender):
    r"""GRU4Rec_test is a model that incorporate RNN for recommendation.
    ...
    def __init__(self, config, dataset):
        super(GRU4Rec_test, self).__init__(config, dataset)
